...
if ($_SESSION['zalogowany'] != 1) { //sprawdzenie czy zalogowany
    ...
    if ($ile > 2)
        ...
        if (isset($_POST['imie']) || isset($_POST['nazwisko']) || isset($_POST['loginu']) || isset($_POST['haslo']) || isset($_POST['dataur']) || isset($_POST['emailu']) || isset($_POST['id'])) {
...
// zapisywanie danych do zmiennych
            ...
            if (empty($imie) || strlen($imie) <= 2) {
                echo '<div class="alert alert-warning" role="alert">Proszę podać imie, musi on zawierać przynajmiej dwa znaki <br><a href="index.php?t=set" class="alert-link">Powrót</a></div>';
            } elseif (empty($nazwisko) || strlen($nazwisko) <= 2) {
                echo '<div class="alert alert-warning" role="alert">Proszę podać nazwisko, musi on zawierać przynajmiej dwa znak <br><a href="index.php?t=set" class="alert-link">Powrót</a></div>';
            } elseif (empty($loginu) || strlen($loginu) <= 2) {
                echo '<div class="alert alert-warning" role="alert">Proszę podać login, musi on zawierać przynajmiej dwa znaki <br><a href="index.php?t=set" class="alert-link">Powrót</a></div>';
            } elseif (empty($haslo) || strlen($haslo) <= 7) {
                echo '<div class="alert alert-warning" role="alert">Proszę podać stare hasło, musi on zawierać przynajmiej osiem znaków <br><a href="index.php?t=set" class="alert-link">Powrót</a></div>';
            } elseif (preg_match("/^( [a-zA-Z0-9] )+( [a-zA-Z0-9\._-] )*@( [a-zA-Z0-9_-] )+( [a-zA-Z0-9\._-] +)+$/", $emailu)) {
                echo '<div class="alert alert-warning" role="alert">Wprowadzony e-mail jest za krótki, lub nieprawny, musi zawierać znak @. <br><a href="index.php?t=set" class="alert-link">Powrót</a></div>';
            } else {
                ...
                if ($bd_haslo != $haslo) {
                    ...
                    echo '<div class="alert alert-warning" role="alert">Podano nieprawidłowe hasło! <br><a href="index.php?t=set" class="alert-link">Powrót</a></div>';
                } else {
                    //gdy ok
                    ...
                    echo '<div class="alert alert-success" role="alert">Uaktualniono dane<br> Zaloguj się ponownie <a href="index.php?t=out" class="alert-link">Powrót</a></div>';
            ...
            <div class="row">
                ...
                <div><form class="form-horizontal form-group"  method="post" action="index.php?t=set">
                        ...
                        <div id="divimie" class="form-group has-feedback">                    
                            ...
                            <div class="col-md-4 ">
                                <input type="text" id="imie" name="imie" required="wymagane pole"  class="form-control" value="<?php echo $_SESSION['imie']; ?>">
                        ...
                        <div id="divnazwisko" class="form-group has-feedback">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" id="nazwisko" name="nazwisko" required="wymagane pole" value="<?php echo $_SESSION['nazwisko']; ?>"></input>
                                <span class="help-block"></span>
                        ...
                        <div id="divloginu"class="form-group has-feedback">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" id="loginu" name="loginu" required="wymagane pole" value="<?php echo $_SESSION['login']; ?>"></input>
                                <span class="help-block"></span>
                        ...
                        <div id="divdataur" class="form-group has-feedback">
                            ...
                            <div class="col-md-4">
                                <input type="date" class="form-control" id="dataur" name="dataur" max="<?php echo date("Y.m.d"); ?>" required="wymagane pole" placeholder="RRRR-MM-DD" value="<?php echo $_SESSION['dataurodzenia']; ?>"></input>
                                <span class="help-block"></span>
                        ...
                        <div id="divemailu" class="form-group has-feedback">
                            ...
                            <div class="col-md-4">
                                <input type="email" class="form-control" id="emailu" name="emailu" required="wymagane pole" value="<?php echo $_SESSION['mail']; ?>"></input>
                                <span class="help-block"></span>
                        ...
                        <div id="submit" class = "col-md-4"> 
                            ...
                            <button type="submit" class="btn btn-warning">Wyślij</button><br><br>
                        </div>
